...
public class hw11_1 {
    private static int chars = 30;

    public static void main(String[] args) throws FileNotFoundException {
        File file = new File("src\\hw11_1\\in.txt");
    ...
    public static void union() throws FileNotFoundException {
        ...
        for (int i = 0; i < chars; i++) {
            scanners[i] = new Scanner(new File("src\\hw11_1\\letters\\letter" + i + ".txt"));
        }
    ...
    public static void split(int count) throws FileNotFoundException {
        ...
        for (int i = 0; i < chars; i++) {
            printWriters[i] = new PrintWriter("src\\hw11_1\\letters\\letter" + i + ".txt");
        }
